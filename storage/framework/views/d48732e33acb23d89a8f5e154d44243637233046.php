    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav align-items-center ms-auto">
                <li class="nav-item"><a class="nav-link active me-3" aria-current="page" <?php echo e(Request::is('hero') ? 'active'  : ""); ?> href="#hero"><span>Beranda</span> <br /><img src="/image/Line 1.svg" alt="" /></a></li>
                <li class="nav-item"><a class="nav-link" <?php echo e(Request::is('komunitas') ? 'active'  : ""); ?> href="#komunitas"><span>Komunitas</span></a></li>
                <li class="nav-item"><a class="nav-link" <?php echo e(Request::is('Tentang') ? 'active'  : ""); ?> href="#Tentang"><span>Tentang Kami</span></a></li>
                <li class="nav-item"><a class="nav-link" <?php echo e(Request::is('dukungan') ? 'active'  : ""); ?> href="#dukungan"><span>Dukungan</span></a></li>
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <li class="nav-item dropdown"  style="list-style: none;">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('layout')); ?>">My Dashboard</a></li>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>"><button class="button-primary">Login</button></a>
                <!-- <a class="a-primary"><img src="/assets/img/login.svg" alt="" /></a> -->
                <a href="<?php echo e(route('register-page')); ?>"><button class="button-secondary">Sign in</button></a>
            <?php endif; ?>
                </div>
        </div>
    </div>
...
<footer id="dukungan">
    <div class="container">
        <div class="col-12 d-flex justify-content-center text-center">
            ...
            <div class="card-dukungan me-5">
                <h6 class="mt-5">Support</h6>
                <a href="<?php echo e(route('booking')); ?>"><p class="mb-2">Start Booking</p></a>
                <p class="mb-2">Help Center</p>
                <p class="mb-2">Server Status</p>
            </div>
            ...
            <div class="card-dukungan me-5">
                <h6 class="mt-5">My Account</h6>
                <a href="<?php echo e(route('profile')); ?>"><p class="mb-2">Profile</p></a>
                <p class="mb-2">Last Booking</p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\ASUS\laravel\Project PijetIn\resources\views/LandingPage/Index.blade.php ENDPATH**/ ?>