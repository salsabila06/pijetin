...
<div class="d-flex flex-column vh-100 flex-shrink-0 p-3 text-dark" style="background-color: #DBFFF6; width: 250px;"> <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none"> <svg class="bi me-2" width="40" height="32"> </svg>
        <ul class="nav nav-pills flex-column mb-auto">
            <li><a href="<?php echo e(route('dashboard')); ?>" class="nav-link text-dark" <?php echo e(Request::is('Dashboard') ? 'active':''); ?>><i class="fa fa-home"><img src="/image/Home.svg" alt=""></i><strong><span class="ms-2">Dashboard</span></strong></a> </li>
            <li><a href=# class="nav-link text-dark" <?php echo e(Request::is('Dashboard') ? 'active':''); ?>> <i class="fa fa-review"><img src="/image/review.svg" alt=""></i><strong><span class="ms-2">Review</span></strong></a></li>
...
<?php /**PATH C:\Users\ASUS\laravel\Project PijetIn\resources\views/Dashboard/Index.blade.php ENDPATH**/ ?>