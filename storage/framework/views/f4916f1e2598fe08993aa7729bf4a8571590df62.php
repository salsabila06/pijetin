...
<nav class="navbar">
    <div class="container-fluid">
        ...
        <form class="d-flex" role="search">
            ...
            <a class="" type="submit"><i class="fa fa-search"></i></a>
            <a class="btn btn-lg" type="submit"><i class="fa fa-bell-o"></i></a>
            <a class="btn btn-lg" href="<?php echo e(route('profile')); ?>"><i class="fa fa-user" ></i></a>
        </form>
    </div>
</nav>
...
<?php /**PATH C:\Users\ASUS\laravel\Project PijetIn\resources\views/Layout/Index.blade.php ENDPATH**/ ?>